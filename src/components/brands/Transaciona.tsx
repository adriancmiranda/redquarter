...
export interface TransacionaProps extends SVGProps<SVGSVGElement> {
...
export const Transaciona = React.forwardRef<SVGSVGElement, TransacionaProps>(({
	accessibilityLabel = '',
	color = '#5D2DCF',
	colorDetails = '#FF352B',
	showText = true,
...
Transaciona.displayName = 'Transaciona';
export default Transaciona;
